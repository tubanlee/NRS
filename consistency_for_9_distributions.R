...
#the simulation codes for consistency, bias, standard error, SRMSE (the codes reall)
...
for (a in (1:300)) {
  ...
  for(i in (1:1)){
    ...
    scale1<-Bias_rqscale(x,target1=(gamma(1+2/(a/100))-(gamma(((1+1/(a/100)))))^2),target2=targetwei[2],interval=9,fast=TRUE,batch=1000,sorted=TRUE)
    all<-c(tmBias=tm1Bias,wmBias=wm1Bias,qmBias=qm1Bias,rmBias=rm1Bias,sqsd=scale1[1],srsd=scale1[2],sql2=scale1[3],srl2=scale1[4])
...
for (a in (1:300)) {
  ...
  for(i in (1:1)){
    ...
    scale1<-Bias_rqscale(x,target1=a/100,target2=targetgam[2],interval=9,fast=TRUE,batch=1000,sorted=TRUE)
    all<-c(tmBias=tm1Bias,wmBias=wm1Bias,qmBias=qm1Bias,rmBias=rm1Bias,sqsd=scale1[1],srsd=scale1[2],sql2=scale1[3],srl2=scale1[4])
...
for (a in (1:300)) {
  ...
  for(i in (1:1)){
    ...
    scale1<-Bias_rqscale(x,target1=(exp((a/100)^2)*(-1+exp((a/100)^2))),target2=targetlnorm[2],interval=9,fast=TRUE,batch=1000,sorted=TRUE)
    all<-c(tmBias=tm1Bias,wmBias=wm1Bias,qmBias=qm1Bias,rmBias=rm1Bias,sqsd=scale1[1],srsd=scale1[2],sql2=scale1[3],srl2=scale1[4])
...
for (a in (1:300)) {
  ...
  for(i in (1:1)){
    ...
    scale1<-Bias_rqscale(x,target1=((2+a/100))*(1)/((-2+(2+a/100))*((-1+(2+a/100))^2)),target2=targetlpareto[2],interval=9,fast=TRUE,batch=1000,sorted=TRUE)
    all<-c(tmBias=tm1Bias,wmBias=wm1Bias,qmBias=qm1Bias,rmBias=rm1Bias,sqsd=scale1[1],srsd=scale1[2],sql2=scale1[3],srl2=scale1[4])
